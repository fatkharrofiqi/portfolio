...
export const DATA = {
  ...
  projects: [
    ...
    {
      title: "Koltitrace & Cocoatrace",
      href: "#",
      dates: "February 2023 - November 2025",
      active: false,
      description: "Supply chain traceability platforms with Node.js serverless logging services and Laravel backend for data management.",
      technologies: ["Node.js", "Laravel", "AWS Lambda", "MongoDB", "MySQL"],
      links: [],
      image: "",
      video: "",
    },
    ...
    },
    {
      ...
      technologies: ["React Native", "TypeScript", "Golang API", "PostgreSQL"],
      links: [
        {
          type: "Android",
    ...
    {
      title: "System Information Personel Polri (SIPP)",
      href: "#",
      dates: "January 2018 - December 2019",
      active: false,
      description: "Comprehensive police personnel management system with full CRUD operations, reporting, and data visualization for internal police use.",
    ...
    {
      title: "System Information Human Resource (SISDM)",
      href: "#",
      dates: "January 2019 - December 2020",
      active: false,
      description: "Mobile-first HR management application for police personnel with offline capabilities and secure data synchronization.",
      technologies: ["React Native", "TypeScript", "Laravel API"],
      links: [],
      image: "",
      video: "",
    },
    {
      title: "System Information Mutation Polri (SISMUTJAB)",
      href: "#",
      dates: "January 2020 - December 2021",
      active: false,
      description: "Personnel mutation and assignment management system with workflow automation and approval processes for police department.",
      technologies: ["Laravel", "React", "MySQL", "MUI Design"],
      links: [],
      image: "",
      video: "",
    },
    {
      title: "System Information Personel ID Card (SIEKTA)",
      href: "#",
      dates: "January 2021 - December 2022",
      active: false,
      description: "Digital ID card generation and management system with QR code integration and secure credential verification.",
      technologies: ["Laravel", "MySQL", "DOMPDF", "Bootstrap"],
      links: [],
      image: "",
      video: "",
    },
    {
      ...
      active: false,
      description: "Teacher assessment and competency tracking system with automated scoring, reporting, and certification management.",
    ...
    {
      title: "MELATI - IT Service Management",
      href: "#",
      dates: "January 2016 - December 2017",
      active: false,
      description: "IT asset and resource management system with inventory tracking, user management, and reporting dashboard for internal IT operations.",
    ...
    },
    {
      ...
      active: false,
      description: "Educational framework management system for student evaluation and teacher feedback with comprehensive reporting and analytics.",
